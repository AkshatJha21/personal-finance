...
const DashboardGrid = () => {
  return (
    <div className="px-6 py-4 flex justify-between min-h-[90%]">
        ...
        <div className="flex flex-col w-full md:w-[30%] items-center h-[85vh] p-8 border ml-6 rounded-2xl dark:border-neutral-500 bg-gradient-to-t dark:bg-gradient-to-b from-indigo-100 to-slate-50 dark:from-neutral-950 dark:to-white/5">
            <Card />
        </div>
    </div>
  )
