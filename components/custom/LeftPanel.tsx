        ...
        <>
            <div className="flex flex-col w-full lg:w-[60%] xl:w-[70%]">
                <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => setOpenPaymentModal(true)} className="flex gap-x-2 items-center px-4 py-2 transition-colors bg-indigo-600 hover:bg-indigo-700 rounded-md text-white">
