...
const Dropdown = () => {
    return (
        <motion.div 
            className=" border dark:border-none rounded bg-gradient-to-b dark:from-white/10 dark:to-white/15 from-slate-100 to-slate-200 shadow-sm p-2 dark:text-slate-200 text-black"
        ...
        >
            <div className="flex flex-col items-start gap-y-1 text-sm">
                <button className="py-2 px-4 transition-all hover:bg-black/30 dark:hover:bg-opacity-10 rounded flex w-full items-center">
